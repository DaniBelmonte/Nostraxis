...
| GitHub Copilot | GitHub Copilot CLI authenticated | `~/.copilot/session-state` | That `copilot` is on `PATH`; for the account quota, sign in with `gh auth login` as well. |
